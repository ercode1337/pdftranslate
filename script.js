...
document.addEventListener("DOMContentLoaded", function() {
  // Handler for "Try Talkano" button click
  document.getElementById("conBtn").addEventListener("click", function() {
    // Replace current HTML content with "Talkano is coming soon!"
    document.getElementById("conP").innerHTML = "Talkano is coming soon!";
  });
});
